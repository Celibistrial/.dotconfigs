...
# to /etc/nixos/configuration.nix instead.
{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/7f474145-2fbf-4d9e-a9f8-d493ef65300d";
    fsType = "btrfs";
  };
  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/74D4-B9C5";
    fsType = "vfat";
  ...
  swapDevices = [
    {device = "/dev/disk/by-uuid/1b99863a-da2b-4953-b016-03f4c35022c2";}
  ];
