...
* i3-config
This is my personal i3-config , parts of it are taken from various parts of the internet
** Keybinds
*** Base
#+begin_src conf
...
mode "lock" {
    ...
    bindsym s exec betterlockscreen --lock dimblur & systemctl suspend, mode "default"
...
client.focused          $colorpCC $colorpCC #ffffff   $colorsCC $colorpCC
client.focused_inactive $colorf   $colorf   #ffffff   $colorsCC $colorf
client.unfocused        $colorf   $colorf   #888888   $colorsCC $colorf
